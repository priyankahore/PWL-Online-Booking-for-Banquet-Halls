...
<section class="content">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Property Owner Table</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
 ...
 <?php  
                    $cnt=0;
                   $result2=mysqli_query($con,"select * from owner");
	...
	<tr>
			...
			<td> <a href="ownerStatus.php?oid=<?php  echo $row['Owner_id'];?>"  class="btn btn-info">Block</a>

			 <a href="owner.php?oid=<?php echo $row['Owner_id'];?>" onclick="deleteuser()" class="btn btn-danger">Delete</a>
...
<?php
  ...
  $did=$_GET['oid'];
        ...
        $q = mysqli_query($con, "delete from owner where Owner_id='$did'");
...
?>
 ...
 <a href="ownerReport.php" class="btn btn-primary">Generate Report</a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
...
var del  =  confirm("Are you sure you want to Delete this Property Owner?");
