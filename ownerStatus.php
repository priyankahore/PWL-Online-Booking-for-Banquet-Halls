...
<section class="content">
 ...
 <?php  
                    ...
                    if(isset($_GET['oid'])){
                    $oid=$_GET['oid'];
                   $result2=mysqli_query($con,"select * from owner where Owner_id='$oid'");
	...
	<tr>
			<form action="ownerStatusAction.php" method="get">
   
      
			
			<td><?php echo $row['Owner_id'];?></td>
    <input type="hidden" name="oid" value="<?php echo $row['Owner_id'];?>" >
      ...
      <option >Unblock</option>
			...
			<td> <input type="submit" value="Submit" name="submit" class="btn btn-info">
			 ...
			 <!-- <a href="deleteUser.jsp?delid=<%out.println(rs.getString(1));%>" onclick="deleteuser()" class="btn btn-danger">Delete</a> -->
