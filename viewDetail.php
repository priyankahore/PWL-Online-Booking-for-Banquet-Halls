     ...
     <div class="row">
       <div class="col-lg-8">
        ...
        ?>
         ...
         <?php  $_SESSION['pname']=$rows['Property_name'];  ?>
         ...
         <h4><?php echo $rows['Description']; ?></h4>
          ...
          <h3 style="color:black;text-align:left; font-weight: bold; "><?php echo $rows['Property_type']; ?> Charges</h3>
            <?php  $_SESSION['ptype']=$rows['Property_type'];  ?>
          <h4><i class="far fa-rupee-sign"></i><?php echo $rows['Property_rate']; ?></h4>
            <?php  $_SESSION['prate']=$rows['Property_rate'];  ?>
           ...
           <h4><i class="far fa-rupee-sign"></i><?php echo $rows['Decoration_rate']; ?></h4>
            <?php  $_SESSION['dsrate']=$rows['Decoration_rate'];  ?>
           ...
           <img src="Owner/<?php echo $rows['Veg_menu']; ?>" width="100px" class="gallery-item" height="100px" alt=""><h4>Veg Menu <i class="far fa-rupee-sign"></i><?php echo $rows['Veg_plate']; ?> per plate</h4> <img src="Owner/<?php echo $rows['Non_veg_menu']; ?>" class="gallery-item" width="100px" height="100px" alt=""><h4>Non veg Menu <i class="far fa-rupee-sign"></i><?php echo $rows['Non_veg_plate']; ?> per plate</h4> 
            ...
            <?php  $_SESSION['nonveg']=$rows['Non_veg_plate'];  ?>
            <?php  $_SESSION['veg']=$rows['Veg_plate'];  ?>
...
?>
 ...
 <?php
      ...
      <input type="text" name="ename" id="ename" class="form-control" value="" placeholder="Enter type of event" >
      <label data-error="wrong" data-success="center" for="id"></label>
    </div>
<?php
...
?>
         ...
         <div class="md-form md-outline">
      <input id="datepicker" type="text" class="form-control" placeholder="Booking Date" name="dates" value="<?php 
                if(isset($_SESSION['dates'])){
                    $dates=$_SESSION['dates'];
                     echo $dates; 
                  }?>" >
     ...
     <div class="md-form md-outline">
      ...
      <input  type="number" class="form-control" placeholder="Enter number of Guest" name="noofguest" id="guest" value="<?php 
     ...
     <div>
      Do you want Catering Service?<br>
      <p class="btn btn-light"><input type="radio" id="yes" name="cservice" value="yes" > <span>Yes</span></p> 
      <p  class="btn btn-light"><input type="radio" id="no" name="cservice" value="No" checked="true"><span>No</span></p>  
    </div>
     
    <div class="md-form md-outline">
      <select name="foodtype" id="q" class="form-control" placeholder="Confirm Password">
      <option value="none">Select the type of Food</option>
    ...
    <div>
      Do you want Decoration Service?<br>
      <p class="btn btn-light"><input type="radio"  name="dservice" value="yes" > <span>Yes</span></p> 
      <p  class="btn btn-light"><input type="radio"  name="dservice" value="No" checked="true"><span>No</span></p>  
    </div>
    ...
    <input type="submit" id="submit" value="Continue to Book" class="block" >
  </form>
       </div>
...
$("input[name='cservice']").change(function(){
  getdata();
   $('#submit').hide();
});
...
$("input[name='dservice']").change(function(){
  getdata();
   $('#submit').hide();
});
$("#ename").change(function(){
  ...
  function getdata(){
    ...
    guest=$('#guest').val();
    var cservice ="None";
    cservice = $("input[name='cservice']:checked").val();
    var foodtype="None"
   ...
   if(cservice=="yes"){
    ...
    var dservice="None";
    dservice = $("input[name='dservice']:checked").val();
 
    $.ajax({
      type:"GET",
      url:"fetch1.php",
      data:{ename:ename,date:date,guest:guest,cservice:cservice,foodtype:foodtype,dservice:dservice,pid:pid},
